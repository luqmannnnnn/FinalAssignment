    ...
    class Program
    {
        ...
        static void DisplayOutstandingPayments(List<Client> clientList, List<Receipt> receiptList)
        {
            ...
            if (DateTime.Now > insuranceEndDate)
            {
                ...
                //Display Receipt
                Console.WriteLine("{0,-30} {1,-15} {2,-15} {3,-15}", "Date & Time", "Client Name", "Item", "Payment Amount");
                Console.WriteLine("{0,-30} {1,-15} {2,-15} {3,-15}", DateTime.Now, r1.ClientName, r1.PaymentItem, r1.PaymentAmt);
